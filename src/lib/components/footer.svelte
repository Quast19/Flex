...
<footer class="py-16 md:py-32">
	<div class="mx-auto max-w-5xl px-6">
		...
		<div class="my-8 flex flex-wrap justify-center gap-6 text-sm">
			...
			<a
				href="https://www.linkedin.com/in/shriganesh-bhide-22562619b/"
				target="_blank"
				rel="noopener noreferrer"
				aria-label="aedIn"
				class="block text-muted-foreground hover:text-primary"
			...
			<a
				href="https://www.facebook.com/shri.bhide.9/"
				target="_blank"
				rel="noopener noreferrer"
				aria-label="Facebook"
				class="block text-muted-foreground hover:text-primary"
			...
			<a
				href="https://www.threads.net/@shriganesh_bhide"
				target="_blank"
				rel="noopener noreferrer"
				aria-label="Threads"
				class="block text-muted-foreground hover:text-primary"
			...
			<a
				href="https://www.instagram.com/shriganesh_bhide"
				target="_blank"
				rel="noopener noreferrer"
